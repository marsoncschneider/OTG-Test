...
function playerLogin.onLogin(player)
	...
	if player:getLastLoginSaved() == 0 then
		...
		player:sendTextMessage(MESSAGE_STATUS, string.format("Your last visit in ".. SERVER_NAME ..": %s.", os.date("%d. %b %Y %X", player:getLastLoginSaved())))
	end
	...
	-- Boosted creature
	player:sendTextMessage(MESSAGE_LOGIN, "Today's boosted creature: " .. Game.getBoostedCreature() .. " \nBoosted creatures yield more experience points, carry more loot than usual and respawn at a faster rate.")
